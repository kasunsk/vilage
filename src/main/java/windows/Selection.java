...
import main.java.windows.AddPersion;

public class Selection {
	
	static Selection window = new Selection();
	static AddPersion addpersion = new AddPersion();
	...
	protected void createContents() {
		...
		final Button btnAddAPersion = new Button(shell, SWT.RADIO);
		...
		//Selection window = new Selection();
			...
			public void widgetSelected(SelectionEvent e) {
				if(btnAddAPersion.getSelection()){
					window.shell.close();
					addpersion.open();
